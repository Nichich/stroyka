...
export default function CatalogPage() {
	...
	const query = useMemo(() => {
		...
		// Или передавайте как есть: q.sortBy = sortBy

		// Пагинация (опционально)
		// q.page = currentPage
		// q.limit = ITEMS_PER_PAGE
					...
					<div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4'>
						...
						<div className='flex gap-3 w-full md:w-auto'>
							<button
								...
								className='md:hidden w-full py-2 border border-gray-300 rounded-lg text-sm font-medium'
							>
								Фильтры
							</button>
